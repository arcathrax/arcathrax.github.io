    ...
    <div className="footerDiv">
      <div className="footerLinksDiv">
        <Link
          ...
          to={"https://www.instagram.com/arcathrax/"}
          target="blank"
        >
          <img
        ...
        <Link
          className="footerLink"
          to={"https://music.apple.com/us/artist/arcathrax/1734394950"}
          target="blank"
        >
          <img
            className="footerIcon"
        ...
        <Link
          className="footerLink"
          to={"https://arcathrax.bandcamp.com/"}
          target="blank"
        >
          <img
            className="footerIcon"
            src={require("./Icons/bandcamp.png")}
            alt="Bandcamp Link"
          />
        </Link>
      </div>
